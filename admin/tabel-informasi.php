    ...
    <script type="text/javascript" language="javascript" >
      ...
      $(document).ready(function() {
        dTable = $('#info').DataTable( {
          "bProcessing": true,
          "bServerSide": true,
          "bJQueryUI": false,
          "responsive": true,
          "sAjaxSource": "joinserverside-info.php", // Load Data
          "sServerMethod": "POST",
          "columnDefs": [
        ...
        $('#info').removeClass( 'display' ).addClass('table table-striped table-bordered');
        $('#info thead th').each( function () {
          
          //Agar kolom Action Tidak Ada Tombol Pencarian
          if( $(this).text() != "Action" ){
            var title = $('#info thead th').eq( $(this).index() ).text();
    ...
    <div class="container-fluid">
      ...
      <a class="btn btn-danger" href="cetak-informasi.php" role="button">Cetak PDF</a>
      </div>
          <table id="info"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
            <thead>
              <tr>
                <th>NIS</th>
                <th>Nama</th>
