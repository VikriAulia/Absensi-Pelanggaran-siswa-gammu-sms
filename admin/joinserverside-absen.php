<?php
	...
	$aColumns = array('k.idkehadiran','a.nis','a.nama','a.kelas', 'k.kehadiran', 'k.jam', 'k.tanggal', 'k.nis'); //Kolom Pada Tabel
	
	// Indexed column (used for fast and accurate table cardinality)
	$sIndexColumn = 'idkehadiran';
	
	// DB table to use
	$sTable = 'kehadiran'; // Nama Tabel
	...
	$sQuery = "
    SELECT SQL_CALC_FOUND_ROWS k.idkehadiran, a.nis ,a.nama, a.kelas, k.kehadiran, k.jam, k.tanggal, a.nis
    FROM ".$sTable." AS k 
	...
	*/
	...
	while ( $aRow = $rResult->fetch_assoc() ) {
		$row = array();
		$btn = '<a href="#" onClick="showModalsdata(\''.$aRow['idkehadiran'].'\')">Edit</a> | <a href="#" onClick="deleteUser(\''.$aRow['idkehadiran'].'\')">delete</a>';
		$row = array($aRow['nis'],$aRow['nama'],$aRow['kelas'],$aRow['kehadiran'], $aRow['jam'], $aRow['tanggal']);
		$output['aaData'][] = $row;
	}
