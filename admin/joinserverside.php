<?php
	...
	$aColumns = array('k.id','a.nis','a.nama','a.kelas', 'k.isipesan', 'k.nis'); //Kolom Pada Tabel
	
	// Indexed column (used for fast and accurate table cardinality)
	$sIndexColumn = 'id';
	
	// DB table to use
	$sTable = 'infomasi'; // Nama Tabel
	...
	$sQuery = "
    SELECT SQL_CALC_FOUND_ROWS k.id, a.nis ,a.nama, a.kelas, k.isipesan, a.nis
    FROM ".$sTable." AS k 
	...
	*/
	...
	while ( $aRow = $rResult->fetch_assoc() ) {
		...
		$row = array( $btn,$aRow['nis'],$aRow['nama'],$aRow['kelas'],$aRow['isipesan']);
		$output['aaData'][] = $row;
	}
