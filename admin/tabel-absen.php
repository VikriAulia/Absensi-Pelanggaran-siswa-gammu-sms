    ...
    <script type="text/javascript" language="javascript" >
      ...
      $(document).ready(function() {
        dTable = $('#absen').DataTable( {
          "bProcessing": true,
          "bServerSide": true,
          "bJQueryUI": false,
          "responsive": true,
          "sAjaxSource": "joinserverside-absen.php", // Load Data
          "sServerMethod": "POST",
          "columnDefs": [
        ...
        $('#absen').removeClass( 'display' ).addClass('table table-striped table-bordered');
        $('#absen thead th').each( function () {
          
          //Agar kolom Action Tidak Ada Tombol Pencarian
          if( $(this).text() != "Action" ){
            var title = $('#absen thead th').eq( $(this).index() ).text();
    ...
    <div class="container-fluid">
      ...
      <a class="btn btn-danger" href="cetak-absensi.php" role="button">Cetak PDF</a>
      </div>
          <table id="absen" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
            <thead>
              <tr>
                <th>NIS</th>
                <th>Nama</th>
    ...
    <!-- Modal Popup -->
    <div class="modal fade" id="PelanggaranModals" tabindex="-1" role="dialog" aria-labelledby="PelanggaranModalLabel" aria-hidden="true">
