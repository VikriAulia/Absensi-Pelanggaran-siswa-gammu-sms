<?php
	...
	$aColumns = array('k.id','a.nis','a.nama','a.kelas', 'k.alasan','k.tanggal', 'k.nis'); //Kolom Pada Tabel
	...
	$sQuery = "
    SELECT SQL_CALC_FOUND_ROWS k.id, a.nis ,a.nama, a.kelas, k.alasan, k.tanggal, k.nis
    FROM ".$sTable." AS k 
	...
	*/
	...
	while ( $aRow = $rResult->fetch_assoc() ) {
		...
		$row = array($aRow['nis'],$aRow['nama'],$aRow['kelas'],$aRow['alasan'],$aRow['tanggal']);
		$output['aaData'][] = $row;
	}
