...
$pdf->Cell(30,10,'Poin', 0, 0, 'C', true);
$pdf->Cell(30,10,'Tanggal', 0, 0, 'C', true);
$pdf->Cell(30,10,'Jenis Pelanggaran', 0, 0, 'C', true);
$pdf->Ln(10);
...
$sql = "SELECT SQL_CALC_FOUND_ROWS k.id, a.nis, a.nama, a.kelas, k.poin, k.tanggal, k.jenis, k.nis 
FROM pelanggaran AS k 
